...
class StoreVehiculeRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'registration_number.required' => "Le numéro de registration est requis.",
            'registration_number.unique' => "Ce numéro de registration est déjà utilisé.",
            ...
            'status.required' => "Le statut du véhicule est requis.",
