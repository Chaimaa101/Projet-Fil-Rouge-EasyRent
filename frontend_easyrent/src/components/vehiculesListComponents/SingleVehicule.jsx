...
export default function CarDetails() { 
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-blue-950 to-black text-white px-10 py-16">
      ...
      >
        ...
        <div className="space-y-6">
          <h1 className="text-4xl font-bold">BMW M4 Competition</h1>
          ...
          <p className="text-gray-300">
            Luxury sports car with premium comfort and extreme performance.
          </p>

          <div className="text-3xl font-bold">
            $120 <span className="text-base text-gray-400">/ day</span>
          </div>

          <button className="px-8 py-4 bg-blue-600 hover:bg-blue-500 rounded-xl transition">
            Book Now
          </button>
        </div>
      </motion.div>
